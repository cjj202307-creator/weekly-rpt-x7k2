...
body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang SC", "Microsoft YaHei", sans-serif; background: #f5f6f8; color: #2c3e50; padding: 28px 18px 60px; }
.wrap { max-width: 860px; margin: 0 auto; }
.back { margin-bottom: 18px; }
.back a { color: #1a5f9e; text-decoration: none; font-size: 13px; font-weight: 600; }
.lg-header { background: #fff; border: 1px solid #eef1f6; border-radius: 14px; padding: 24px 28px 20px; margin-bottom: 20px; position: relative; overflow: hidden; }
.lg-header::after { content: ''; position: absolute; left: 0; right: 0; bottom: 0; height: 6px; background: linear-gradient(120deg, #3498db 0%, #1a5f9e 100%); }
.lg-header h1 { font-size: 21px; font-weight: 800; color: #1a1a2e; margin-bottom: 8px; }
.lg-header .sub { font-size: 13px; color: #8898aa; line-height: 1.7; }
.lg-stats { margin-top: 12px; display: flex; flex-wrap: wrap; gap: 8px; }
.lg-stat { background: #e8f2fb; color: #1a5f9e; font-size: 12px; font-weight: 600; padding: 4px 12px; border-radius: 12px; }
.lg-item { background: #fff; border: 1px solid #eef1f6; border-radius: 12px; padding: 16px 18px; margin-bottom: 12px; }
.lg-head { display: flex; align-items: center; flex-wrap: wrap; gap: 8px 10px; margin-bottom: 10px; }
.lg-avatar { width: 30px; height: 30px; border-radius: 50%; background: linear-gradient(135deg,#3498db,#1a5f9e); color: #fff; font-size: 13px; font-weight: 700; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
.lg-name { font-size: 15px; font-weight: 700; color: #1a1a2e; }
.lg-o { background: #eef1f6; color: #8898aa; font-size: 11px; font-weight: 600; padding: 2px 8px; border-radius: 8px; }
.lg-kr { font-size: 13px; color: #8898aa; flex: 1 1 200px; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.lg-date { font-size: 12px; color: #8898aa; margin-left: auto; }
.lg-chg { border-top: 1px solid #eef1f6; padding-top: 10px; margin-top: 2px; }
.lg-chg + .lg-chg { margin-top: 8px; }
.lg-field { font-size: 12px; font-weight: 700; color: #8898aa; margin-bottom: 6px; }
.lg-add { background: #e8f2fb; color: #1a5f9e; border-radius: 8px; padding: 8px 12px; font-size: 13px; line-height: 1.7; margin-bottom: 4px; white-space: pre-wrap; word-break: break-word; }
.lg-del { color: #8898aa; font-size: 12px; line-height: 1.6; text-decoration: line-through; white-space: pre-wrap; word-break: break-word; margin-bottom: 4px; }
.lg-note { display: inline-block; font-size: 11px; color: #c0392b; font-weight: 600; margin-bottom: 4px; }
.lg-pct { font-size: 14px; font-weight: 700; color: #1a1a2e; }
.lg-pct .delta { color: #1a5f9e; }
.lg-pct .arrow { color: #8898aa; font-weight: 400; }
.lg-none { font-size: 12px; color: #8898aa; line-height: 1.6; }
details.lg-full { margin-top: 4px; }
details.lg-full summary { font-size: 12px; color: #8898aa; cursor: pointer; user-select: none; }
details.lg-full .fullrow { font-size: 12px; color: #8898aa; line-height: 1.7; margin-top: 6px; white-space: pre-wrap; word-break: break-word; background: #f0f2f5; border-radius: 8px; padding: 8px 12px; }
details.lg-full .fullrow b { color: #1a1a2e; font-weight: 700; }
.lg-empty { text-align: center; color: #8898aa; font-size: 14px; padding: 60px 0; }
...
.lock-error{color:#d32f2f;font-size:14px;margin-top:14px;display:none}
.lock-hint{margin-top:20px;font-size:12px;color:#999}
</style>
</head>
<body>
<div class="lock-card">
